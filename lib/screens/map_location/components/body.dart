...
class _BodyState extends State<Body> {
  ...
  String? msg;
  String webUrl =
      "https://fluttercorner.000webhostapp.com/provider/providerupdateadress.php";
  bool _enabled = false;
  void _toggle() {
    setState(() {
      _enabled = !_enabled;
                  ...
                  markers: {
                    Marker(
                      onTap: () {
                        ...
                        debugPrint(currentPostion.latitude.toString());
                        debugPrint(currentPostion.longitude.toString());
                      },
                      draggable: true,
