...
class NewServiceRequests extends StatefulWidget {
  const NewServiceRequests({Key? key}) : super(key: key);

  @override
  State<NewServiceRequests> createState() => _NewServiceRequestsState();
}

class _NewServiceRequestsState extends State<NewServiceRequests> {
                                          ...
                                          MaterialPageRoute(
                                            builder: (context) =>
                                              ...
                                              serviceImages: data[index]
                                                  ['service_images'],
                                              serviceImages1: data[index]
                                                  ['images1'],
                                              serviceImages2: data[index]
                                                  ['images2'],
                                            ),
                                          ))
                                      .then((value) =>
